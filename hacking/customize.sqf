...
ExAd_HACKING_MAX_DISTANCE = 150;					//SCALAR - Maximum distance away from the object being hack players for the hack to proceed. 

ExAd_HACKING_TERRITORY_MAX = 1;					//SCALAR - Maximun times a territory can get hacked before a new restart.
...
ExAd_HACKING_PLAYER_ONLINE = true;				//BOLLEAN - True if a player with build permissions for a base needs to be online for a hack to be possible.